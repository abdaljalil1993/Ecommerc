...
<div style="width: 850px;margin: 20px auto;padding: 20px;border-radius: 10px;box-shadow: 0px 0px 3px 5px #ccc">
	 <form action="join.php" method="post">
       ...
       <input type="text" placeholder="Simple Message " class="form-control" name="s"><br>
            <textarea class="form-control" name="exp" placeholder="About Your Experiance "></textarea><br>

            <input type="submit" name="btn" class="btn btn-primary" value="Join Us">
...
$r=mysqli_query($con,"insert into jointb(name,email,msg,skils)
  values('$name','$email','$sub','$exp')");
