...
<div class="container" >
  <div class="row">
   ...
   <h1 class="text-warning">All Join Request</h1> 
    <hr>
...
$con=mysqli_connect("localhost","bacttrai_WPERM","fadidebow@1993","bacttrai_WPERM")or die("error db".mysqli_error($con));
    ...
    */
    $t=mysqli_query($con,"select * from jointb");
...
<td><a href="jr.php?id='.$row['id'].'" class="btn btn-danger">Delete</a></td>
  ...
  if(isset($_GET['id']))
    {
      ...
      $t=mysqli_query($con,"delete from jointb where id='$x'");
      if(isset($t)){
        echo '<script type="text/javascript">toastr.success("delete users Successfully");</script>';
       echo' <meta http-equiv="refresh" content="0 ;url=jr.php" />';
      }
    }
