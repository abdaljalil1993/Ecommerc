...
<div class="container" >
  <div class="row">
    ...
    <h1 class="text-warning">Add New User</h1> 
    <hr>
   <form action="au.php" method="post" >
      <input type="text" placeholder="name" class="form-control" name="n"> <br>

 <input type="email" placeholder="email" class="form-control" name="ph"> <br>

  <input type="text" placeholder="password" class="form-control" name="de"> <br>
    ...
    <a style="color: white;" href="index.php#contact"> Contact Us</a></li>
          ...
          <div class="col-md-4 col-sm-12" style="height: 240px;">
            ...
            <br>
              ...
              <span style="color: white"> <i style="color:#D69B25;font-size: 20px; " class=" fa fa-envelope"></i> info@realestate.sy</span>
              <br>
              <br>
      ...
      <li><a href="#" style="color: white"><i style="color:#D69B25;font-size: 28px; " class=" fab fa-facebook"></i> RealEstate</a></li><br>
      <li><a href="#"  style="color: white"><i style="color:#D69B25;font-size: 28px; " class=" fab fa-twitter"></i> @RealEstate.sy</a></li><br>
      
      <li><a href="#"  style="color: white"><i style="color:#D69B25;font-size: 28px; " class=" fab fa-instagram"></i> RealEstate</a></li><br>
...
<div style="height: 40px;background-color:#10305a;padding-top: 6px; ">
  <p class="text-center text-warning">All Right Reserved To RealEstate <i class="fa fa-heart"></i> 2021</p>
...
$r=mysqli_query($con,"insert into users(name,email,password)
  values('$name','$phone','$des')");
