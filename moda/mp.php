...
<div class="container" >
  <div class="row">
   ...
   <h1 class="text-warning">All Produts</h1> 
    <hr>
...
$con=mysqli_connect("localhost","bacttrai_WPERM","fadidebow@1993","bacttrai_WPERM")or die("error db".mysqli_error($con));
    ...
    */
    $t=mysqli_query($con,"select * from products");
...
<td>'.$row['color'].'</td>
<td>'.$row['cat'].'</td>
<td><img src="upload/'.$row['image'].'" style="width:100px;height:100px;"></td>

<td><a href="mp.php?id='.$row['id'].'" class="btn btn-danger">Delete</a></td>
  ...
  if(isset($_GET['id']))
    {
      ...
      $t=mysqli_query($con,"delete from products where id='$x'");
      if(isset($t)){
        echo '<script type="text/javascript">toastr.success("delete users Successfully");</script>';
       echo' <meta http-equiv="refresh" content="0 ;url=mp.php" />';
      }
    }
