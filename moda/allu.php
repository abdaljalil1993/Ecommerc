...
<div style="background-image: url('images/6655.jpg');background-repeat: no-repeat;background-size: cover;background-attachment: fixed; height: 600px; ">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
   <ul class="navbar-nav mr-auto">
      <li class="nav-item active x" >
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="admin.php">Home <span class="sr-only">(current)</span></a>
      </li>
  

        <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="allu.php">all users</a>
      </li>
       <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="au.php">Add users</a>
      </li>
     

      <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="home.php">Search Home</a>
      </li>
    </ul>
...
<div style="height:120px;"></div>
 ...
 <h1>RealEstate | Find Your Dream Home </h1>
 <h3>Add New House </h3>
  </div>
...
<div style="width: 100%;  background-color:rgba(10,54,108,0.7);" >
  ...
  <li><i class="fa fa-angle-double-right text-warning"></i> <a style="color: white;" href="book.php"> Book home</a></li>
