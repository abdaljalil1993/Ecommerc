...
<div style="background-image: url('images/mm.jpg');background-repeat: no-repeat;background-size: cover;background-attachment: fixed; height: 320px; ">
<div style="background-color:rgba(10,54,108,0.3);width: 100%;height: 320px; ">
  <div class="mynav">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <li class="dropdown nav-item x" style="list-style-type: none;">
        <a  style="color: #E7E7E8; font-size: 17px;" class="dropdown-toggle a" data-toggle="dropdown" href="#"> Category
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
           <li><a style="color: gold; font-size: 17px;" class="nav-link a" href="home.php">  All Products</a></li>
          <li><a style="color: gold; font-size: 17px;" class="nav-link a" href="home.php?type=men">  Men</a></li>
          <li><a style="color: gold; font-size: 17px;" class="nav-link a"  href="home.php?type=women"> Women</a></li>

          <li><a style="color: gold; font-size: 17px;" class="nav-link a" href="home.php?type=child">  Children</a></li>
...
{
  $x=$_GET['type'];
$r=mysqli_query($con,"select * from products where cat='$x'");
while($row=mysqli_fetch_array($r))
{
  ...
  <div class="col-4">
    ...
    <hr>
    <img src="upload/'.$row['image'].'" style="width: 100%;height: 300px;"><br>
    <p style="word-wrap: break-word;">description : '.$row['description'].'</p>
     <p class="text-danger">Price : '.$row['price'].'</p>
      <h3 class="text-primary">Size :'.$row['size'].'</h3>
       <h3 class="text-primary">Colors :'.$row['color'].'</h3>
...
while($row=mysqli_fetch_array($r))
{
  echo'
    ...
    <p style="word-wrap: break-word;">description : '.$row['description'].'</p>
     <p class="text-danger">Price : '.$row['price'].'</p>
      <h4 class="text-primary">Size :'.$row['size'].'</h4>
       <h4 class="text-primary">Colors :'.$row['color'].'</h4>
  ...
  <li><i class="fa fa-angle-double-right text-warning"></i>
    <a style="color: white;" href="index.php#contact"> Contact Us</a></li>
    			...
    			<div class="col-md-4 col-sm-12" style="height: 240px;">
    				...
    				<span><a href="#"  style="color: white"><i style="color:#D69B25;font-size: 20px; " class=" fa fa-phone"></i> 00966 5621 75</a></span><br><br>

            <span style="color: white"> <i style="color:#D69B25;font-size: 20px; " class=" fab fa-whatsapp"></i> 00966 7373 795</span><br>
            <br>

    					<span><a href="#"  style="color: white"><i style="color:#D69B25;font-size: 20px; " class=" fab fa-whatsapp"></i> 00966 4621 335</a></span><br><br>
