...
<div style="background-image: url('images/mmm.jpg');background-repeat: no-repeat;background-size: cover;background-attachment: fixed; height: 600px; ">
...
<div class="container" >
  <div class="row">
   ...
   <form action="login.php" method="post">
     ...
     <a href="sign.php" class="text-warning">new member? create new account</a>
   </form>
    </div>
    </div>
