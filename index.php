...
<div style="background-image: url('images/mm.jpg');background-repeat: no-repeat;background-size: cover;background-attachment: fixed; height: 600px; ">
<div style="background-color:rgba(10,54,108,0.2);width: 100%;height: 600px; ">
	<div class="mynav">
	<nav class="navbar navbar-expand-lg navbar-light " id="navbar">
  <a class="navbar-brand text-uppercase" id="nn" href="#" style="color: #D69B25; font-size: 23px;" >  RealEstate</a>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active x" >
        ...
        <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="join.php">Join Us</a>
      </li>

         <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="home.php">Offers</a>
      </li>
    ...
    <a class="btn btn-outline-warning my-2 my-sm-0 mr-2" href="com.php">Competetion</a>
...
<div class="container vx" style="height: 150px;margin-top: 0px;margin-bottom: 20px;position: relative;display: block;">
	...
	<div class="row">
			...
			<div style=" ">
				...
				<h3>Our Mision</h3>
				<p>Our Mission is to deliver the best clothes and moda staff to all our investors by doing things differently</p>
		...
		<div class="  vv mb-3">
			<div style=" ">
				...
				<h3>Our Vision</h3> 
				<p>Is to be a to deliver the best clothes and moda staff to all our investors by doing things differently</p>
		...
		<div class=" vv mb-3">
			<div style=" ">
				...
				<h3>Our Value</h3>
				<p>to deliver the best clothes and moda staff to all our investors by doing things differently</p>
...
<div class="container" >
	<div class="row">
	<div class="col-md-6">
			<p class="text-justify" style="font-size: 20px;">Our business is helping our clients to deliver the best clothes and moda staff to all our investors by doing things differently
</p>
	</div>
	<div class="col-md-6">
			<p class="text-justify" style="font-size: 20px;">We are a trusted company that offer the best offers in the market and we insure the good service that delevired from us 
</p>
	</div>
...
<div class="image-container" id="book">
    <img alt="book consultation image hero-bg" src="images/mm.jpg" style="width: 100%;height: 340px;" />
    <div class="after">
    	<div class="container">
    		<div style="height: 80px;"></div>
    		<div class="row">
    			<div class="col-md-9">
    				<h2  class="text-warning">Search, Find , All Offers And Clothes  </h2>
    				<p class="text-justify" style="font-size: 18px;">here you can find every thing you need about Moda and trading </p></div>
    			<div class="col-md-3">
    				<br>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <span style="font-size: 24px;color:#21537C;letter-spacing: 1px; ">&nbsp;Latakia - 8 adar street</span>
      <hr>

      <i class="fa fa-envelope" style="font-size: 20px;color:#21537C "></i> 
      <span style="font-size: 24px;color:#21537C;letter-spacing: 1px; ">&nbsp; info@moda.sy</span>
      <hr>
      ...
      <span style="font-size: 24px;color:#21537C;letter-spacing: 1px; "> <a style="color:#21537C " href="#" target="blank">&nbsp; Realestate</a></span>
      <hr>
...
<div class="image-container" >
    <img alt="book consultation image hero-bg" src="images/m11.jpg" style="width: 100%;height: 340px;" />
    <div class="after">
      <div class="container">
        <div style="height: 80px;"></div>
        <div class="row">
          <div class="col-md-9">
            <h2  class="text-warning">see What people say about our services and give us feedback <br>
...
<div style="height: 20px;"></div>
<div style="background-image: url('images/m11.jpg');background-size: cover;background-attachment: fixed;background-repeat: no-repeat;">
...
<div style="width: 100%;  background-color:rgba(10,54,108,0.7);" >
 ...
 <li><i class="fa fa-angle-double-right text-warning"></i> <a href=""><a style="color: white;" href="index.php#about"> Join Us</a></a></li>

  <li><i class="fa fa-angle-double-right text-warning"></i> <a href=""><a style="color: white;" href="index.php#about"> Competetion</a></a></li>
  ...
  <li><i class="fa fa-angle-double-right text-warning"></i>
    <a style="color: white;" href="index.php#contact"> Contact Us</a></li>
            ...
            <br>
    					...
    					<span style="color: white"> <i style="color:#D69B25;font-size: 20px; " class=" fa fa-envelope"></i> info@moda.sy</span>
    					<br>
    					<br>
			...
			<li><a href="#" style="color: white"><i style="color:#D69B25;font-size: 28px; " class=" fab fa-facebook"></i> moda</a></li><br>
			<li><a href="#"  style="color: white"><i style="color:#D69B25;font-size: 28px; " class=" fab fa-twitter"></i> @moda.sy</a></li><br>
			
			<li><a href="#"  style="color: white"><i style="color:#D69B25;font-size: 28px; " class=" fab fa-instagram"></i> moda</a></li><br>
...
<div style="height: 40px;background-color:#10305a;padding-top: 6px; ">
	<p class="text-center text-warning">All Right Reserved To moda <i class="fa fa-heart"></i> 2021</p>
...
<script type="text/javascript">
  ...
  $('#WAButton').floatingWhatsApp({
    phone: '00963 993 537 451', //WhatsApp Business phone number International format-
