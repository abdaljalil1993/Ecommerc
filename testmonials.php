...
<div style="background-color:rgba(10,54,108,0.2);width: 100%;height: 600px; ">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <a class="btn btn-outline-warning my-2 my-sm-0 mr-2" href="#book">Competetion</a>
...
<div class="container">
	...
	<?php
include 'conn.php';
$r=mysqli_query($con,"select * from jointb ");
while($row=mysqli_fetch_array($r))
{
    ...
    <p style="word-wrap: break-word;">email : '.$row['email'].'</p>
      ...
      <h3 class="text-primary">message :'.$row['msg'].'</h3>
