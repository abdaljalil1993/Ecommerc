...
<div class="container-fluid top-bar" >
    ...
    <ul class="social">
  <li>    <a href="admlog.php" class="btn btn-outline-warning btn-sm">Admin</a></li>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active x" >
        ...
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="join.php">Join Us</a>
         ...
         <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="#about">Offers</a>
      </li>
...
<div class="container" >
  <div class="row">
    ...
    <h1 class="text-warning">Create New Account</h1> 
    <hr>
 ...
 <input type="email" placeholder="email" class="form-control" name="e"> <br>
  ...
  <input type="text" placeholder="password" class="form-control" name="p"> <br>

     <input type="submit" name="btn" class="btn btn-warning btn-lg" value="Save"><br><br>

      <a href="login.php" class="text-warning">Have Account ? Login Here</a>
   </form>
