...
<div style="background-image: url('images/mm.jpg');background-repeat: no-repeat;background-size: cover;background-attachment: fixed; height: 400px; ">
<div style="background-color:rgba(10,54,108,0.2);width: 100%;height:400px; ">
  <div class="mynav">
...
<div style="width: 850px;margin: 20px auto;padding: 20px;border-radius: 10px;box-shadow: 0px 0px 3px 5px #ccc">
	 <form action="com.php" method="post" enctype="multipart/form-data">
            ...
            <h2 class="text-primary">Register With Competetion</h2>
            <hr>
       ...
       <input type="text" placeholder="Email : email@example.com " class="form-control" name="e"><br>
            ...
            <textarea class="form-control" name="exp" placeholder="About Your Experiance "></textarea><br>
            <label>Samples Work</label>
       <input type="file" placeholder="resume " class="form-control" name="s"><br>
...
<div style="width: 100%;  background-color:rgba(10,54,108,0.7);" >
 ...
 <li><i class="fa fa-angle-double-right text-warning"></i> <a href=""><a style="color: white;" href="join.php"> Join Us</a></a></li>
...
$resumename=isset($_FILES['s']['name'])?$_FILES['s']['name']:'';
$resume=isset($_FILES['s']['tmp_name'])?$_FILES['s']['tmp_name']:'';
...
move_uploaded_file($resume, "upload/$resumename");
$r=mysqli_query($con,"insert into comp(name,email,skils,resume)
  values('$name','$email','$exp','$resumename')");
